...
uicontrol('Style','pushbutton','Units','normalized',...
   ...
   'Callback',['load(get(fn4,''string''));'...
      ...
      'set(a4,''ylim'',[-5 .8*median(c_viz)],''xlim'',[1 clll]);']);
...
set(l,'ydata',c_viz,'xdata',1:clll,'marker','.',...
   'LineStyle','none');
set(a4,'ylim',[-2 .8*median(c_viz)],'xlim',[1 clll+1]);
...
uicontrol('Style','pushbutton','Units','normalized',...
   ...
   'FontWeight','bold','fontsize',10,...
   'Callback','g=gcbo; eeg_patt_loc_coef_vis_scr_1');
...
set(ad4,'ylimmode','manual','ylim',[-.001 .05*mean(c_viz)]);
