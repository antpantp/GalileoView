...
sfd2=uicontrol('Style','pushbutton','Units','normalized',...
   ...
   'Callback','set(itd2,''ForegroundColor'',[1 0 0],''string'',''Wait for set functions to be created...'',''visible'',''on''); pause(.1); F=funsetcreation_tr(wf,str2num(get(lfs2,''string'')),sc,dl,As,Bs);set(itd2,''string'',[ num2str(size(F,1)) '' Functions are ready.''],''ForegroundColor'',[0 1 0]);[str,stb]=size(F);   str_cntr=0;    set(lchd2,''Color'',[1 0 0]);');
